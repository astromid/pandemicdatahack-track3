...
# RAW_TRAIN = pd.read_csv(RAW_DATA_PATH / 'train.csv', sep=';')
# RAW_TEST = pd.read_csv(RAW_DATA_PATH / 'test.csv', sep=';')
# RAW_EDUCATION = pd.read_csv(RAW_DATA_PATH / 'education_mult.csv', sep=';')
# INTERIM_EMPLOYEMENTS = pd.read_csv(INTERIM_DATA_PATH / 'employements_mult_new.csv', sep=';')
# RAW_WORLDSKILLS = pd.read_csv(RAW_DATA_PATH / 'worldskills.csv', sep=';')
